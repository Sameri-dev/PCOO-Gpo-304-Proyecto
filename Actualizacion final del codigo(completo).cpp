...
int main() {
// Crear empleado 1
    Empleado empleado1("Sam Medina", "Recepcionista", 123456);
//Mostrar los datos del empleado 1
    empleado1.mostrarDatos();
//Crear empleado 2
    Empleado empleado2("Hector Sanchez", "Gerente", 789012);
// Mostrar los datos de empleado 2
    empleado2.mostrarDatos();

// Pedir datos al cliente
    string nombreCliente;
    int numeroRegistroCliente;
//nombre
    cout << "\nIngrese su nombre: ";
    getline(cin, nombreCliente);
//numero
    cout << "Ingrese su número de registro: ";
    cin >> numeroRegistroCliente;

// Creamos cliente
    Cliente cliente(nombreCliente, numeroRegistroCliente);

// Mostramos datos del cliente
    cliente.mostrarDatos();

// Asignar habitación según tipo de cliente
    if (numeroRegistroCliente % 5 == 0) {
        HabitacionVIP habitacionVIP(numeroRegistroCliente);
        cliente.asignarHabitacion(&habitacionVIP);
    } else if (numeroRegistroCliente % 3 == 0) {
        HabitacionNormal habitacionNormal(numeroRegistroCliente);
        cliente.asignarHabitacion(&habitacionNormal);
    } else {
        HabitacionEstandar habitacionEstandar(numeroRegistroCliente);
        cliente.asignarHabitacion(&habitacionEstandar);
    }

// Mostrar habitación asignada al cliente
    cliente.mostrarHabitacion();
